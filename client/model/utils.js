...
function locale() {
    var lang = navigator.languages || navigator.language || navigator.userLanguage;
    lang = typeof(lang) == "object" ? lang[0] : lang;
    return lang.split("-").map((a, b) => b == 0 ? a : a.toUpperCase()).join("-")
}
