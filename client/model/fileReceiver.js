...
export default class FileReceiver extends Nanobus {
    ...
    async downloadBlob(noSave = false, token) {
        ...
        try {
            ...
            let plainStream = eceModule.decryptStream(blobStream(ciphertext), this.keychain.rawSecret);
            if (this.fileInfo.type === 'send-archive') {
                const zip = new zipModule.Zip(this.fileInfo.manifest, plainStream);
