...
export default (state, emit) => {
    ...
    >
      ...
      >
        ...
        <input
          id="password-input"
          class="w-full border-l border-t border-b rounded-l-lg rounded-r-none ${state.fileInfo.invalidPwd
        ...
        <input
          type="submit"
          id="password-btn"
          class="btn rounded-r-lg rounded-l-none ${state.fileInfo.invalidPwd
      ...
      <label
        id="password-error"
        class="${state.fileInfo.invalidPwd ? '' : 'invisible'} text-red dark:text-red-40 my-4"
        for="password-input"
      >
