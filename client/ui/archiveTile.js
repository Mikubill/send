...
import { bytes, copyToClipboard, percent, platform, timeLeft } from '../model/utils';
...
const archived = (state, emit, archive) => {
    const copyOrShare =
    ...
    >
      ...
      <div class="text-sm opacity-75 w-full mt-3 mb-2">
